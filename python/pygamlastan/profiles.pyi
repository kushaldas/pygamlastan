...
class SessionParticipant:
    ...
    @property
    def slo_url(self) -> str | None: ...
    @property
    def slo_binding(self) -> str | None: ...
    @property
    def session_not_on_or_after(self) -> datetime | None: ...
...
class SamlSession:
    def __init__(
        ...
        principal_name_id_format: str | None = ...,
        authn_context_class_ref: str | None = ...,
        session_not_on_or_after: datetime | None = ...,
        participants: list[SessionParticipant] | None = ...,
    ) -> None: ...
    @property
    def session_index(self) -> str: ...
    @property
    def principal_name_id(self) -> str: ...
    @property
    def principal_name_id_format(self) -> str | None: ...
    @property
    def authn_instant(self) -> datetime: ...
    @property
    def authn_context_class_ref(self) -> str | None: ...
...
class InMemorySessionStore:
    ...
    def create_session(self, session: SamlSession) -> str: ...
    def get_session(self, session_index: str) -> SamlSession | None: ...
    def get_sessions_by_name_id(self, name_id: str) -> list[SamlSession]: ...
    def get_sessions_for_participant(
        self,
        requester_entity_id: str,
        name_id: NameId,
        session_indexes: list[str] | None = ...,
    ) -> list[SamlSession]: ...
    def take_sessions_for_participant(
        self,
        requester_entity_id: str,
        name_id: NameId,
        session_indexes: list[str] | None = ...,
    ) -> list[SamlSession]: ...
    def add_participant(self, session_index: str, participant: SessionParticipant) -> bool: ...
    def remove_participant(self, session_index: str, entity_id: str) -> bool: ...
